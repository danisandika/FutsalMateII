...
@NamedQueries({
    ...
    @NamedQuery(name = "TbAdmin.findByNama", query = "SELECT t FROM TbAdmin t WHERE t.nama = :nama"),
    @NamedQuery(name = "TbAdmin.findByEmail", query = "SELECT t FROM TbAdmin t WHERE t.email = :email"),
    @NamedQuery(name = "TbAdmin.findByNotelp", query = "SELECT t FROM TbAdmin t WHERE t.notelp = :notelp"),
...
public class TbAdmin implements Serializable {
    ...
    public TbAdmin(Integer idAdmin, String nama, String email, String password) {
        this.idAdmin = idAdmin;
        this.nama = nama;
        this.email = email;
